    ...
    <>
      <div className="h-screen flex items-center w-full justify-center lg:">
        ...
        <div className="h-full flex items-center justify-center lg:justify-end">
          <div className="text-white flex flex-col items-center justify-center rounded-[1rem] lg:rounded-none h-[45rem] w-[30rem] bg-[var(--primary-color)] lg:h-full 2xl:w-[40rem]">
