          ...
          >
            ...
            <div className="mt-2 space-y-1 ml-4">
              <p className="text-xs text-gray-300">
                <span className="text-purple-300">Produto:</span>{" "}
                {movement.items[index].product.name || "N/A"}
              </p>
              <p className="text-xs text-gray-300">
                <span className="text-purple-300">Quantidade:</span>{" "}
                {movement.items[index].quantity}
              </p>
